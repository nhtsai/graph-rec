...
1. Download and extract the MovieLens-1M dataset from [here](http://files.grouplens.org/datasets/movielens/ml-1m.zip) into the current directory.
...
1. Download and extract the Nowplaying-rs dataset from [here](https://zenodo.org/record/3248543/files/nowplayingrs.zip?download=1) into the current directory.
